    ...
    EconomyCatalog {
        ...
        resources: vec![
            ...
            equipment_resource(
                ...
                RefinementScalingDef {
                    damage_per_tier: 1,
                    precision_per_tier: 1,
                    protection_per_tier: 0,
                    prestige_per_tier: 1,
                    durability_per_tier: 2,
                },
                &["metal"],
                true,
                true,
            ...
            equipment_resource(
                ...
                RefinementScalingDef {
                    damage_per_tier: 0,
                    precision_per_tier: 0,
                    protection_per_tier: 1,
                    prestige_per_tier: 1,
                    durability_per_tier: 3,
                },
                &["cloth"],
            ...
            equipment_resource(
                "cota_malha_simples",
                "Cota de malha simples",
                &["armor", "prestige", "trade_good"],
                24,
                ItemClass::Armor,
                &[EquipmentSlot::Body],
                30,
            ...
            equipment_resource(
                ...
                18,
                ItemClass::Clothing,
                &[EquipmentSlot::Body, EquipmentSlot::Outer],
                22,
                10,
                ItemCombatStats {
                    damage: 0,
            ...
            equipment_resource(
                "anel_cobre",
                "Anel de cobre",
                &["jewelry", "prestige", "trade_good"],
                12,
                ItemClass::Jewelry,
                &[EquipmentSlot::Accessory1, EquipmentSlot::Accessory2],
                30,
                8,
                ItemCombatStats::default(),
                RefinementScalingDef {
                    damage_per_tier: 0,
                    precision_per_tier: 0,
                    protection_per_tier: 0,
                    prestige_per_tier: 2,
                    durability_per_tier: 1,
                },
                &["copper"],
                true,
                true,
        ...
        roles: vec![
            ...
            role(
                Role::Blacksmith.id(),
                Role::Blacksmith.as_str(),
                &["forja", "alfaiataria", "ourivesaria"],
            ),
        ...
        spatial_archetypes: vec![
            ...
            archetype("alfaiataria", "Alfaiataria", LocationKind::Workshop),
            archetype("ourivesaria", "Ourivesaria", LocationKind::Workshop),
        ...
        establishment_types: vec![
            ...
            EstablishmentTypeDef {
                id: "alfaiataria".to_string(),
                display_name: "Alfaiataria".to_string(),
                spatial_archetype_id: "alfaiataria".to_string(),
                location_kind: LocationKind::Workshop,
                public_service: false,
                owner_policy: OwnerPolicyDef::PrivateByRole {
                    role_id: Role::Blacksmith.id().to_string(),
                ...
                stock_targets: vec![
                    stack("tecido", 10),
                    stack("couro", 6),
                    stack("tunica_simples", 2),
                    stack("manto", 1),
                ],
                default_stock: vec![stack("tecido", 6), stack("couro", 3)],
                production_recipe_ids: vec![
                    "costurar_tunica_simples".to_string(),
                    "costurar_tunica_boa".to_string(),
                    "costurar_manto".to_string(),
                    "costurar_vestido_refinado".to_string(),
                    "preparar_gambesao".to_string(),
                    "preparar_couro_reforcado".to_string(),
                ],
                construction_recipe_id: Some("construir_alfaiataria".to_string()),
                production_recipe_id: Some("costurar_tunica_simples".to_string()),
            },
            EstablishmentTypeDef {
                id: "ourivesaria".to_string(),
                display_name: "Ourivesaria".to_string(),
                spatial_archetype_id: "ourivesaria".to_string(),
                location_kind: LocationKind::Workshop,
                public_service: false,
                owner_policy: OwnerPolicyDef::PrivateByRole {
                    role_id: Role::Blacksmith.id().to_string(),
                ...
                default_stock: vec![stack("cobre", 4), stack("prata", 2)],
                production_recipe_ids: vec![
                    "forjar_faca".to_string(),
                    "forjar_clava".to_string(),
                    "forjar_espada_curta".to_string(),
                    "forjar_machado".to_string(),
                    "forjar_lanca_simples".to_string(),
                    "forjar_cota_malha".to_string(),
                    "forjar_capacete".to_string(),
                    "forjar_escudo".to_string(),
                    "lavrar_anel_cobre".to_string(),
                    "lavrar_anel_prata".to_string(),
                    "lavrar_broche".to_string(),
                    "lavrar_colar".to_string(),
                ],
                construction_recipe_id: Some("construir_ourivesaria".to_string()),
                production_recipe_id: Some("forjar_faca".to_string()),
            },
            EstablishmentTypeDef {
        ...
        recipes: vec![
            ...
            recipe(
                "costurar_vestido_refinado",
                "alfaiataria",
                "vestido_refinado",
                1,
                vec![input("tecido", 4), input("prata", 1)],
                vec![],
                10,
                0,
                66,
            ...
            recipe(
                ...
                vec![
                    input(ResourceKind::MetalBruto.id(), 1),
                    input(ResourceKind::Madeira.id(), 1),
                ],
                vec![input(ResourceKind::Ferramentas.id(), 1)],
                7,
                2,
            ...
            recipe(
                ...
                "clava",
                1,
                vec![input(ResourceKind::Madeira.id(), 2)],
                vec![input(ResourceKind::Ferramentas.id(), 1)],
                6,
                1,
                52,
            ...
            recipe(
                ...
                1,
                vec![
                    input(ResourceKind::MetalBruto.id(), 3),
                    input(ResourceKind::Madeira.id(), 1),
                ],
                vec![input(ResourceKind::Ferramentas.id(), 1)],
                10,
            ...
            recipe(
                ...
                1,
                vec![
                    input(ResourceKind::MetalBruto.id(), 2),
                    input(ResourceKind::Madeira.id(), 2),
                ],
                vec![input(ResourceKind::Ferramentas.id(), 1)],
                9,
                3,
            ...
            recipe(
                ...
                "cota_malha_simples",
                1,
                vec![input(ResourceKind::MetalBruto.id(), 4)],
                vec![input(ResourceKind::Ferramentas.id(), 1)],
                11,
                4,
                70,
            ...
            recipe(
                ...
                "capacete_simples",
                1,
                vec![input(ResourceKind::MetalBruto.id(), 2)],
                vec![input(ResourceKind::Ferramentas.id(), 1)],
                8,
                2,
                64,
            ...
            recipe(
                ...
                "broche",
                1,
                vec![input("cobre", 1), input("prata", 1)],
                vec![input(ResourceKind::Ferramentas.id(), 1)],
                8,
                1,
                66,
...
pub fn validate_catalog(catalog: &EconomyCatalog) -> Result<()> {
    ...
    for resource in &catalog.resources {
        ...
        if resource.item_class.is_some() {
            if resource.equip_slot_preferences.is_empty() {
                return Err(anyhow!(
                    "resource `{}` is equipable but has no equip_slot_preferences",
                    resource.id
                ));
            }
            if resource.base_durability <= 0 {
                return Err(anyhow!(
                    "resource `{}` is equipable but has non-positive base_durability",
                    resource.id
                ));
            }
        }
...
fn resource(
    ...
    ResourceDef {
        ...
        base_durability: 0,
        base_prestige: 0,
        base_combat_stats: ItemCombatStats::default(),
        refinement_scaling: RefinementScalingDef::default(),
        material_tags: Vec::new(),
    }
}

#[allow(clippy::too_many_arguments)]
fn equipment_resource(
    id: &str,
    display_name: &str,
    tags: &[&str],
    base_price: i32,
    item_class: ItemClass,
    equip_slot_preferences: &[EquipmentSlot],
    base_durability: i32,
    base_prestige: i32,
    ...
    resource.base_durability = base_durability;
    resource.base_prestige = base_prestige;
    resource.base_combat_stats = base_combat_stats;
    resource.refinement_scaling = refinement_scaling;
    resource.material_tags = material_tags.iter().map(|tag| tag.to_string()).collect();
    resource
}
...
fn infer_affordances(tags: &[&str]) -> Vec<ItemAffordanceDef> {
    ...
    if tags.contains(&"weapon") {
        affordances.push(affordance(ItemAffordanceKind::Weapon, 10, false));
    }
    if tags.contains(&"armor") {
        affordances.push(affordance(ItemAffordanceKind::Armor, 10, false));
    }
    if tags.contains(&"clothing") {
        affordances.push(affordance(ItemAffordanceKind::Clothing, 8, false));
    }
    if tags.contains(&"jewelry") {
        affordances.push(affordance(ItemAffordanceKind::Jewelry, 8, false));
    }
    if tags.contains(&"prestige") {
        affordances.push(affordance(ItemAffordanceKind::Prestige, 8, false));
    }
